    ...
    <Layout>
      <div className="flex h-[85vh] gap-4">
        ...
        <div className="flex-1 bg-gray-100 rounded-xl p-4 shadow-inner flex flex-col">
          <div className="flex justify-end gap-2 mb-3">
            {[1, 4, 9].map((n) => (
              <button
                ...
                className={`px-3 py-1 rounded-lg border transition-all ${selectedCount === n
          ...
          <div
            className={`grid gap-3 flex-1 ${selectedCount === 1
                ? "grid-cols-1"
                : selectedCount === 4
                  ? "grid-cols-2"
                  : "grid-cols-3"
            ...
            <ul className="space-y-2">
              {cameraList.map((cam) => (
                <li
                  ...
                  className={`cursor-pointer border rounded-lg p-2 transition ${selectedCameras.find((c) => c.id === cam.id)
                ...
                >
                  ...
                  <div
                    className={`text-[10px] ${cam.status === "active" || cam.status === true
                        ? "text-green-500"
                        : "text-red-500"
                      }`}
                  >
